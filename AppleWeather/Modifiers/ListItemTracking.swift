...
//  https://github.com/Ceylo/ListItemTracking/blob/main/Sources/ListItemTracking/ListItemTracking.swift
//
        ...
        content
            .background {
                GeometryReader { itemGeometry in
                    let itemFrameIgnoringSafeArea = itemGeometry.frame(in: .named("Alex.ListFrame.Scroll.Alex"))
...
struct ListFrameTracking: ViewModifier {
    func body(content: Content) -> some View {
        content
            .coordinateSpace(name: "Alex.ListFrame.Scroll.Alex")
    }
}
